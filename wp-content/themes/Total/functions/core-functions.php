...
function wpex_get_first_term_id( $post = '', $taxonomy = 'category', $terms = '' ) {
	...
	$terms = $terms ? $terms : get_the_terms( $post, $taxonomy );
...
function wpex_get_post_primary_taxonomy( $post = null ) {
	...
	return apply_filters( 'wpex_post_primary_taxonomy', $taxonomy );
...
function wpex_get_entry_image_animation_classes() {
	...
	$animation = $animation = get_theme_mod( $type . '_entry_image_hover_animation' );
...
function wpex_get_social_button_class( $style = 'default' ) {
	...
	switch ( $style ) {
		...
		// Colored
		case 'colored':
			$style = 'wpex-social-btn-colored wpex-social-color';
			break;
...
function wpex_get_button_classes( $style = array(), $color = '', $size = '', $align = '' ) {
	...
	$classes = apply_filters( 'wpex_button_classes', $classes, $args );
	$classes = array_map( 'esc_attr', $classes );
	$classes = array_filter( $classes );

	$class = implode( ' ', $classes );
	return apply_filters( 'wpex_get_theme_button_classes', $class, $style, $color, $size, $align ); // @todo deprecate
}
...
function wpex_get_masonry_settings() {
	...
	return apply_filters( 'wpex_masonry_settings', $settings );
